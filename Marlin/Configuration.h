...
#define STRING_CONFIG_H_AUTHOR "Dane Caro" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anvil3D Dart Frog"
...
#define POLAR
  ...
  #define PRINTABLE_RADIUS 50.0f            // (mm) Maximum travel of X axis
...
#define X_BED_SIZE 100.0
#define Y_BED_SIZE 100.0
